...
export default function Header() {
  ...
  const menuItems: INavigationMenuItem[] = [
    ...
    {
      title: "DAO Governance (Comming soon)",
      href: "/dao-governance",
      disabled: true,
    },
    ...(authToken ? [{ title: "Profile", href: "/profile" }] : []),
  ];
              ...
              <NavigationMenuItem key={index}>
                ...
                >
                  <Link
                    ...
                    } ${item.disabled && "text-muted-foreground dark:text-muted-foreground cursor-not-allowed pointer-events-none"}`}
                    href={item.href}
                  >
                    {item.title}
                  </Link>
